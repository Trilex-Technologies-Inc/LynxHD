...
<div class="card shadow-sm mb-4 border-0">
 ...
 <div class="card-body"><form method="post" enctype="multipart/form-data" class="form-row align-items-start"><input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf,ENT_QUOTES,'UTF-8') ?>"><div class="form-group col-md-8 col-lg-9 mb-md-0"><label for="module-zip">Module ZIP file</label><div class="custom-file"><input class="custom-file-input" id="module-zip" type="file" name="module_zip" accept=".zip,application/zip" required><label class="custom-file-label" for="module-zip">Choose ZIP file</label></div><small class="form-text text-muted">Maximum size: 10 MB. Packages must contain module.json and bootstrap.php.</small></div><div class="form-group col-md-4 col-lg-3 mb-0"><label class="d-none d-md-block" aria-hidden="true">&nbsp;</label><button class="btn btn-primary btn-block d-inline-flex align-items-center justify-content-center text-nowrap font-weight-bold shadow-sm" name="upload_module" value="1"><i class="fas fa-cloud-upload-alt mr-2" aria-hidden="true"></i><span>Upload &amp; install</span></button></div></form></div>
</div>
