...
echo "<ul>";
echo "<li><img src=\"./images/mail.png\" /> <b>" . get_row_count( "SELECT COUNT(*) FROM {$pre}ticket WHERE ( status = '$HD_STATUS_OPEN' )" ) . "</b> ticket(s) open";
echo "<li><img src=\"./images/mail-closed.png\" /> <b>" . get_row_count( "SELECT COUNT(*) FROM {$pre}ticket WHERE ( status != '$HD_STATUS_OPEN' )" ) . "</b> ticket(s) closed or held";

echo "<li><img src=\"./images/mail-newresponse.png\" /> <b>{$unanswered}</b> ticket(s) awaiting a reply";
