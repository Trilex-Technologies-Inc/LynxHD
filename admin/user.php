...
<li>
	...
	<div class="buttons">
    <button type="submit" class="positive">Create User</button>
    </div>
</form>
</div>
<br />
...
if( $_GET['cmd'] != "view" )
{
  ...
  if( mysql_num_rows( $res ) )
  {
    ...
    echo "<tr bgcolor=\"#3c91c7\"><td width=\"50\">&nbsp;</td><td><div class=\"tableheader\">Name</div></td><td><div class=\"tableheader\">Email</div></td></tr>\n";
    ...
    while( $row = mysql_fetch_array( $res ) )
    {
      ...
      if( $global_priv && !$row['admin'] )
        $output .= "<a href=\"javascript:if(confirm('Are you sure you want to delete this user?')) window.location.href = '$HD_CURPAGE?cmd=del&id={$row['id']}'\"><img src=\"./images/ticket-delete.png\" border=\"0\" alt=\"Delete User\" hspace=\"2\" /></a>";
      else
        $output .= "<img src=\"./images/nodelete.png\" hspace=\"2\" />";

      $output .= "<a href=\"$HD_CURPAGE?cmd=view&id={$row['id']}\"><img src=\"./images/info.png\" border=\"0\" alt=\"User Info\" hspace=\"2\" /></a></td>";
...
else if( $_GET['cmd'] == "view" )
{
  ...
  echo "<table width=\"100%\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\" bgcolor=\"#99CCFF\"><tr><td><div class=\"tableheader\">Viewing user info for " . field( $row['name'] ) . "</div></td></tr><tr><td bgcolor=\"#FFFFFF\">";
  ...
  echo "<tr><td colspan=\"2\"><img src=\"./images/blank.gif\" width=\"1\" height=\"8\" /></td></tr>";
  echo "<tr><td colspan=\"2\" align=\"center\" bgcolor=\"#99CCFF\"><div class=\"normal\"><b>Departments</b></div></td></tr>";
  echo "<tr><td colspan=\"2\"><img src=\"./images/blank.gif\" width=\"1\" height=\"8\" /></td></tr>";
  ...
  {
    echo "<tr><td colspan=\"2\"><img src=\"./images/blank.gif\" width=\"1\" height=\"8\" /></td></tr>";
    echo "<tr><td colspan=\"2\" align=\"center\" bgcolor=\"#99CCFF\"><div class=\"normal\"><b>Recent Posts</b></div></td></tr>";
    echo "<tr><td colspan=\"2\"><img src=\"./images/blank.gif\" width=\"1\" height=\"8\" /></td></tr>";
    ...
    echo "<tr bgcolor=\"#99CCFF\"><td><div class=\"tableheader\">Ticket#</div></td><td><div class=\"tableheader\">Subject</div></td><td><div class=\"tableheader\">Ticket Date</div></td></tr>";
