...
<?php else: ?><div class="alert alert-light border shadow-sm"><i class="fas fa-info-circle text-muted mr-2"></i>Install and enable the Live Chat module to include its activity in this report.</div><?php endif; ?>
