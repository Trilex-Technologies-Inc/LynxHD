...
?>
<div class="d-sm-flex align-items-center justify-content-between mb-4"><div><h1 class="h3 mb-1 text-gray-800">Live Chat Settings</h1><p class="mb-0 text-muted">Configure the widget, website embed, and reusable replies.</p></div><a class="btn btn-primary mt-3 mt-sm-0" href="livechat.php"><i class="fas fa-comments mr-1"></i>Open conversations</a></div>
<?php echo $msg ?>
<?php if (!$installed): ?>
